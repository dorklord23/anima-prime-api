...
First of all thank you very much for your interest in Anima Prime API. I have been trying to make my own open source projects since I was still in college to no avail. With your help, I hope we could make this project successful and active.

I believe guideline is one of the signs of professionalism. Therefore,  I hope you follow the guidelines outlined in this document because I personally take this seriously.

Currently, I need help in writing the API documentation, adding new endpoints, and writing unit tests (unit tests are foreign stuff for me). Because I have yet to see the need to set up multiple means of communication, every communication between contributors and users will be conducted solely in issue tracker with appropriate labels for now.

# Ground Rules
I believe in the Be Nice, Be Respectful (BNBR) rule. Therefore, every contributor (including myself) will refrain from sarcasm, witty one-liner, snark, profanity, and any other form of speech that offend other people in regard to the development of this project. Please refer to this project's [Code of Conduct](https://github.com/dorklord23/anima-prime-api/blob/master/CODE_OF_CONDUCT.md) for further reading on this topic.

## Responsibilities
> * Create issues for any major changes and enhancements that you wish to make. Discuss things transparently and get community feedback.
> * Keep feature versions as small as possible, preferably one new feature per version.
> * Be welcoming to newcomers—especially novice programmers—and encourage diverse new contributors from all backgrounds.

# Your First Contribution
> COMING SOON

Novice programmers, please read these resources before submitting your first Pull Request.
...
## THE FOLLOWING IS WORK ON PROGRESS
